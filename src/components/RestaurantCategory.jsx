...
const RestuarantCategory = ({data}) => {
    ...
    const allItems = data.categories.flatMap(category => category.itemCards.map(item => item.card.info)); 
    ...
    return(<div className="w-9/12">
        ...
        <div className="mx-auto border-[1px] border-black p-4 my-2 w-full ">
            <div className="flex justify-between p-4">
            <span className="font-bold ">{data.title} ({totalItemCards})</span>
